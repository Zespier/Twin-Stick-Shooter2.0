...
public class AudioManager : MonoBehaviour {
    ...
    public void ShipSound(Vector3 speed) {
        ...
        float targetValue = Mathf.Lerp(shipSoundMinPitch, shipSoundMaxPitch, (Ship.instanceOfClient.Stats.Speed * max) / Ship.instanceOfClient.Stats.Speed);
    ...
    public void ShootSound() {
        ...
        if (_canShootSoundAgain) {
            ...
            Voice _audioSource = audioPool.PlayVoice(shootClips[Random.Range(0, shootClips.Count)], shootsVolume, VoicePriority.OwnerBulletShoot, Ship.instanceOfClient.transform.position, defaultSettings);
